...
void TypeIIRMLMath::printProfile_RML(TypeIIRMLMath::Step1_Profile profile)
{
	switch (profile)
	{
	case  TypeIIRMLMath::Step1_Undefined:				std::cout << "undefined"; return;
	case  TypeIIRMLMath::Step1_Profile_PosLinHldNegLin: std::cout << "pos lin hold neg lin"; return;
	case  TypeIIRMLMath::Step1_Profile_PosLinNegLin:	std::cout << "pos lin neg lin"; return;
	case  TypeIIRMLMath::Step1_Profile_PosTriNegLin:	std::cout << "pos tri neg lin"; return;
	case  TypeIIRMLMath::Step1_Profile_PosTrapNegLin:	std::cout << "pos trap neg lin"; return;
	case  TypeIIRMLMath::Step1_Profile_NegLinHldPosLin: std::cout << "neg lin hold pos lin"; return;
	case  TypeIIRMLMath::Step1_Profile_NegLinPosLin:	std::cout << "neg lin pos lin"; return;
	case  TypeIIRMLMath::Step1_Profile_NegTriPosLin:	std::cout << "neg tri pos lin"; return;
	case  TypeIIRMLMath::Step1_Profile_NegTrapPosLin:	std::cout << "neg trap pos lin"; return;
	}
}
...
// 이거 좀 이상함... ProfileStep1PosLinHldNegLin 랑 같아야될거 같은데 이상하게(?) 다름
